package test.tantalum.message.test.service;
...
import test.tantalum.message.MessageApplication;
...
import test.tantalum.message.service.EntityToOutputConverter;
import test.tantalum.message.service.MessageService;
import test.tantalum.message.service.ServiceDiscoveryHelper;
